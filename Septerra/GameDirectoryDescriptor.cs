...
namespace Septerra
{
    public sealed class GameDirectoryDescriptor
    {
        ...
        public String SRExecutablePath => Path.Combine(DirectoryPath, "SR-Septerra.exe"); // https://github.com/M-HT/SR
        ...
        public Boolean IsSRExecutableExists => File.Exists(SRExecutablePath);
